...
var Bacino;
(function (Bacino) {
    Bacino[Bacino["FC"] = 0] = "FC";
    Bacino[Bacino["RA"] = 1] = "RA";
    Bacino[Bacino["RN"] = 2] = "RN";
})(Bacino || (Bacino = {}));
var CU;
(function (CU) {
    CU[CU["Forli"] = 0] = "Forli";
    CU[CU["Cesena"] = 1] = "Cesena";
    CU[CU["Cesenatico"] = 2] = "Cesenatico";
    CU[CU["Ravenna"] = 3] = "Ravenna";
    CU[CU["Faenza"] = 4] = "Faenza";
    CU[CU["Rimini"] = 5] = "Rimini";
})(CU || (CU = {}));
var TL;
(function (TL) {
    TL[TL["U"] = 0] = "U";
...
const MyRepo = {
    ...
    funs: {
        getCUs: (bacino) => MyRepo.cus.filter(it => Enum[it.bacino] === bacino).map(it => Enum[it.cu]),
        getLinee: (bacino, cu) => MyRepo.linee.filter(it => it.b === Enum[bacino] && (!cu || it.cu === Enum[cu])),
    },
    testFuns: {
...
exports.repo = MyRepo;
//# sourceMappingURL=tpldata.js.map